    ...
    methods: {
      getTableData () {
        this.$axios({
          ...
          data: {page: this.start, business_id: this.$route.query.business_id, limit: 20, ...this.formInline},
          fuc: (res) => {
            if (res.code === 200) {
      ...
      detailGoodsDetail (row) {
        this.$router.push({path: '/business/onlineBusinessGoodsDetail', query: {gid: row.gid, business_id: this.$route.query.business_id}})
      },
      addGoods () {

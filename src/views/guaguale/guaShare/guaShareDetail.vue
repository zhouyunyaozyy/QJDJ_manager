...
//    this.initChart()
    ...
    methods: {
      ...
      getLineData () {
        ...
        this.$axios({
            type: 'post',
            url: '/game/overallCount',
            data: {act_start: this.timePicker[0] / 1000, act_end: this.timePicker[1] / 1000},
            fuc: (res) => {
            //        if (res.code )
      ...
      getTableData () {
        this.$axios({
          type: 'post',
          url: '/game/activeShareCount',
          data: {page: this.start, page_size: 20, act_id: 2},
          fuc: (res) => {

...
<script>
  export default {
    ...
    methods: {
      ...
      addSlideshow () {
        this.$router.push({path: '/interConfig/goldMail/goldMailRecommendedOperatingGoodsDetail', query: {goods_activity_category_id: this.$route.query.goods_activity_category_id}})
      },
      ...
      editGoods (goods_activity_id) {
        this.$router.push({path: '/interConfig/goldMail/goldMailRecommendedOperatingGoodsDetail', query: {goods_activity_category_id: this.$route.query.goods_activity_category_id, goods_activity_id}})
      },
      downExcell () {

...
<script>
  export default {
    ...
    methods: {
      ...
      addSlideshow () {
        this.$router.push({path: '/interConfig/goldMail/goldMailOperatingGoodsDetail', query: {goods_activity_category_id: this.$route.query.goods_activity_category_id}})
      },
      ...
      goGoodsDetail () {
        this.$router.push({path: '/goldMail/goldMailOperatingGoodsDetail', query: {goods_activity_category_id: this.$route.query.goods_activity_category_id}})
      },
      editGoods (goods_activity_id) {
        this.$router.push({path: '/interConfig/goldMail/goldMailOperatingGoodsDetail', query: {goods_activity_category_id: this.$route.query.goods_activity_category_id, goods_activity_id}})
      },
      downExcell () {

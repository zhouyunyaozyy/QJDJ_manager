...
<script>
  export default {
    ...
    methods: {
      ...
      addSlideshow () {
        this.$router.push({path: '/interConfig/silverMail/silverMailRecommendedGoodsDetail'})
      },
      ...
      editGoods (goods_activity_id) {
        this.$router.push({path: '/interConfig/silverMail/silverMailRecommendedGoodsDetail', query: {goods_activity_category_id: this.$route.query.goods_activity_category_id, goods_activity_id}})
      },
      downExcell () {

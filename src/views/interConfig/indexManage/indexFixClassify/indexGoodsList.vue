    ...
    methods: {
      getTableData () {
        this.$axios({
          ...
          data: {page: this.start, goods_activity_category_id: 1, filter_category_id: this.$route.query.goods_activity_category_id, ...this.formInline},
          fuc: (res) => {
      ...
      addSlideshow () {
        this.$router.push({path: '/interConfig/indexManage/indexGoodsDetail', query: {goods_activity_category_id: this.$route.query.goods_activity_category_id}})
      },
      ...
      editGoods (goods_activity_id) {
        this.$router.push({path: '/interConfig/indexManage/indexGoodsDetail', query: {goods_activity_id, goods_activity_category_id: this.$route.query.goods_activity_category_id}})
      }
    }
  }
</script>

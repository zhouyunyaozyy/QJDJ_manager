    ...
    methods: {
      getTableData () {
        this.$axios({
          ...
          data: {page: this.start, goods_activity_category_id: this.$route.query.goods_activity_category_id, filter_category_id: this.$route.query.goods_activity_category_id, ...this.formInline},
          fuc: (res) => {
      ...
      addSinglePackage (row) {
        this.$axios({
          ...
          data: { goods_activity_category_id: this.$route.query.goods_activity_category_id, package_id: row.package_id},
          fuc: (res) => {
            if (res.code == 200) {
      ...
      addPackages () {
        if (this.selectedArr.length < 1) {
          ...
          this.$axios({
            type: 'post',
            url: '/goods/activitypackageadd',
            data: { goods_activity_category_id: this.$route.query.goods_activity_category_id, package_id: this.selectedArr},
            fuc: (res) => {
              if (res.code == 200) {
                this.$message.success('添加成功')

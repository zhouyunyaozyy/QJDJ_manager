  ...
  export default {
    ...
    methods: {
      ...
      goDetail (goods_activity_business_id) {
        this.$router.push({path: '/interConfig/indexManage/indexBusinessDetail', query: {goods_activity_category_id: this.$route.query.goods_activity_category_id, goods_activity_business_id}})
      },
      addBusiness () {

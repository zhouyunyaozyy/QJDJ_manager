  ...
  <div class="indexSlideshowDetail">
    <el-form ref="form" :model="form" label-width="120px" :rules='rules'>
      <el-form-item label='商品编码' prop='goods_no'>
        ...
        <el-button @click='goods_noSure'>确认</el-button>
      </el-form-item>
            ...
            this.$axios({
              ...
              fuc: (res) => {
                if (res.code == 200) {
                  ...
                  this.$deleteOneTag('/interConfig/indexManage/indexGoodsList',  {goods_activity_category_id: this.$route.query.goods_activity_category_id})
                }
              }
            })
          }

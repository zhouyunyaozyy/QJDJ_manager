  ...
  export default {
    ...
    methods: {
      ...
      editIconClassify (row) {
        this.$router.push({path: '/interConfig/indexManage/indexIconClassifyDetail', query: {goods_activity_category_id: row.goods_activity_category_id}})
      },

<template>
  <div class="indexSlideshowDetail">
    <el-form ref="form" :model="form" label-width="120px" :rules='rules'>
      ...
      <el-form-item label='是否爆品' prop='is_hot' v-if='businessSureBool && categoryBool'>
        <el-select v-model='form.is_hot' placeholder="请选择" clearable>
          <el-option
            label="是"
            value="1">
          </el-option>
      ...
      <el-form-item label='标签' v-if='form.is_hot == 1' prop='tag'>
        <el-input v-model="form.tag" placeholder='两个标签用英文逗号隔开'></el-input>
      </el-form-item>
    ...
    data () {
      return {
        ...
        rules: {
          ...
          is_hot: [{ required: true, message: '请选择', trigger: 'blur' }],
            ...
            this.$axios({
              ...
              fuc: (res) => {
                if (res.code == 200) {
                  ...
                  this.$deleteOneTag('/interConfig/indexManage/indexOperatingGoodsList',  {goods_activity_category_id: this.$route.query.goods_activity_category_id, template_id: this.$route.query.template_id})
                }
              }
            })
          }

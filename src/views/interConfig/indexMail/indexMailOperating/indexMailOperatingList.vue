    ...
    methods: {
      getTableData () {
        this.$axios({
          ...
          data: {parent_id: 2, type: 3, is_fixed_od: 1},
          fuc: (res) => {
      ...
      editOperating (goods_activity_od_id) {
        this.$router.push({path: '/interConfig/indexMail/indexMailOperatingDetail', query: {goods_activity_od_id: goods_activity_od_id}})
      },
      goOperatingGoodsRoute (goods_activity_category_id) {
        this.$router.push({path: '/interConfig/indexMail/indexMailOperatingGoodsList', query: {goods_activity_category_id: goods_activity_category_id}})
      }
    }
  }
</script>

...
<script>
  export default {
    ...
    methods: {
      ...
      addSlideshow () {
        this.$router.push('/interConfig/indexMail/indexMailSlideshowDetail')
      },
      editSlideShow (row) {
        this.$router.push({path: '/interConfig/indexMail/indexMailSlideshowDetail', query: {goods_activity_carousel_id: row.goods_activity_carousel_id}})
      },
      removeSlideShow (row) {
        this.$axios({
          type: 'post',

  ...
  export default {
    ...
    methods: {
      ...
      editIconClassify (row) {
        this.$router.push({path: '/interConfig/indexMail/indexMailRecommendedClassify', query: {goods_activity_category_id: row.goods_activity_category_id}})
      },
      goGoods (row) {
        this.$router.push({path: '/interConfig/indexMail/indexMailRecommendedList', query: {goods_activity_category_id: row.goods_activity_category_id}})
      },
      goBusiness (row) {
        this.$router.push({path: '/interConfig/indexMail/indexBusinessList', query: {goods_activity_category_id: row.goods_activity_category_id}})
      },
      goPackages (row) {
        this.$router.push({path: '/interConfig/indexMail/indexPackagesList', query: {goods_activity_category_id: row.goods_activity_category_id}})
      },
